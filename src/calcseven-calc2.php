	...
	<article class="wpc-calc">
		<section>
			...
			<div class="panel panel-default">
				<div class="panel-body">HOW TO USE : Fill in the details required in the Yellow Highlighted Areas - The results will then appear in the Far right columns.</div>
			</div>
			<form class="form">
